...
//
//    private static final int millitime = 4500;
//    private static final int ADDITIONAL_TIME = 20;
//    private static final double lowMaxPower = 0.3;
...
//    private final Pose turnPose = new Pose(49, 14.65, Math.toRadians(180+22));
//    private final Pose controlPickup4Ready = new Pose(140-91.26233766233766, 21.506493506493506, Math.toRadians(180+22));
//    private final Pose pickup4Ready = new Pose(140-131.47012987012988, 17.95324675324676, Math.toRadians(180+22));
...
//    private final Pose pickup4Pose = new Pose(140-135.51807228915663, 7.1325301204819205, Math.toRadians(180));
//
...
//
//    //private final Pose pickup5Ready = new Pose(140-131.47012987012988, 17.95324675324676, Math.toRadians(180+22));
//    //    private final Pose controlPickup5Pose_1 = new Pose(122.21686746987952, 10.987951807228908, Math.toRadians(0));
////    private final Pose controlPickup5Pose_2 = new Pose(135.32530120481928, 15.807228915662655, Math.toRadians(0));
//    //private final Pose pickup5Pose = new Pose(140-135.51807228915663, 7.1325301204819205, Math.toRadians(180));
//
...
////        .addParametricCallback(1, () -> Algorithm.shootMode4.shootTime(millitime))
//                .build();// 😧
//        turn = new Path(new BezierCurve(scorePose,turnPose));
//        turn.setLinearHeadingInterpolation(scorePose.getHeading(), turnPose.getHeading());
//
//        runto4 = new Path(new BezierCurve(turnPose,controlPickup4Ready,pickup4Ready));
//        runto4.setLinearHeadingInterpolation(turnPose.getHeading(), pickup4Ready.getHeading());
...
//                .addPath(new BezierCurve(pickup4Ready, pickup4Pose))
...
//        return false;
//    }
//    private boolean pathTimeout(int millitime,int nextState) {
//        if (pathTimer.getElapsedTime() > millitime) {
//            follower.breakFollowing();   // 强制停止路径
//            setPathState(nextState);     // 直接跳到下一个安全状态
//            return true;
//        }
