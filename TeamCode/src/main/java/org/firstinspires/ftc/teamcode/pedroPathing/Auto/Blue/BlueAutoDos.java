...
public class BlueAutoDos extends OpMode {
    ...
    private static final double getPointPreX = 140-95;
    private static final double getPointX = 140-126.5;
...
//un dux toi
    ...
    private final Pose end = new Pose(140-102, 14.8, Math.toRadians(180-32));
