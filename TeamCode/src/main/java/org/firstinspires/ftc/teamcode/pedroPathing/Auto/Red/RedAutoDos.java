...
@Autonomous(name = "RedAutoDos(coop--3+'2')", group = "Competition")
public class RedAutoDos extends OpMode {
    ...
    private final Pose controlScorePose = new Pose(93, 62.9, Math.toRadians(32));
...
//    private final Pose scorePose1 = new Pose(113, 111, Math.toRadians(32));//
    ...
    private final Pose scorePose3 = new Pose(113, 109, Math.toRadians(40));
...
//    private final Pose pickup1Pose = new Pose(getPointX, Point1Y, Math.toRadians(0));
    ...
    private PathChain grabPickup1, grabPickup2, grabPickup3, scorePickup1, scorePickup2, scorePickup3, runTheGate;
